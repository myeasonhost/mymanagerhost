...
import com.eason.report.pull.ds.config.AgInfoConfig;
import com.eason.report.pull.ds.exception.AgException;
...
public class RunnerListener implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        Object pullUrl = stringRedisTemplate10.boundHashOps("ds").get("pullUrl");
        Object pidtoken = stringRedisTemplate10.boundHashOps("ds").get("pidtoken");
        if (pullUrl == null) {

...
@NamedStoredProcedureQueries({
        @NamedStoredProcedureQuery(name = "mdt_jd_site_pull", procedureName = "mdt_jd_site_pull",
                parameters = {

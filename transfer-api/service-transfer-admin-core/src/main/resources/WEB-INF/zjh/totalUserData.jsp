...
<%String path = request.getContextPath(); %>
 <table id="table_grid"  style="min-width:1000px;" data-options="fitColumns:'true',rownumbers:'true',striped:'true'">
	...
	<tr> 
		...
		<th data-options="field:'totalPlayerNum',sortable:'true',align:'center'" width='15%'>用户总数</th>
		<th data-options="field:'newLogin',sortable:'true',align:'center'" width='15%'>日新登</th>
		<th data-options="field:'vnu',sortable:'true',align:'center'" width='15%'>有效新登</th>
		<th data-options="field:'vnuPercent',sortable:'true',align:'center'" width='15%'>有效率(玩3局)</th>
		<th data-options="field:'dau',sortable:'true',align:'center'" width='15%'>日活跃</th>
		<th data-options="field:'d1rr',sortable:'true',align:'center'" width='15%'>最近1个次日留存</th>    
		<th data-options="field:'d3rr',sortable:'true',align:'center'" width='15%'>最近1个3日留存</th>
		<th data-options="field:'totalRecharge',sortable:'true',align:'center'" width='15%'>日付费额</th>
		<th data-options="field:'rechargePlayerNum',sortable:'true',align:'center'" width='15%'>日付费人数</th>
		<th data-options="field:'rechargeCount',sortable:'true',align:'center'" width='15%'>日付费次数</th>
		</tr>
	</thead>
 	<tbody>
 	</tbody>
...
$(function(){ 
	$('#table_grid').datagrid({ 
		width:"auto",
	    height:"auto", 
	    url:"<%=path%>/admin/business/userData/query",
		checkOnSelect:false,
	  	selectOnCheck:false,
	  	singleSelect:true,
		striped:true, 

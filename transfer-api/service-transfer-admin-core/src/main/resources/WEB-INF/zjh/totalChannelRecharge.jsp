...
<%String path = request.getContextPath(); %>
 <table id="table_grid"  style="min-width:1000px;" data-options="fitColumns:'true',rownumbers:'true',striped:'true'">
	...
	<thead>
		...
		<th data-options="field:'totalRecharge',sortable:'true',align:'center'" width='15%'>充值金额</th>
		<th data-options="field:'rechargePlayerNum',sortable:'true',align:'center'" width='15%'>充值人数</th>
		<th data-options="field:'dnuRechargeCount',sortable:'true',align:'center'" width='15%'>充值次数</th>
		</tr>
	</thead>
 	<tbody>
 	</tbody>
...
$(function(){ 
	$('#table_grid').datagrid({ 
		width:"auto",
	    height:"auto", 
	    url:"<%=path%>/admin/business/channelRecharge/query",
		checkOnSelect:false,
	  	selectOnCheck:false,
	  	singleSelect:true,
		striped:true, 

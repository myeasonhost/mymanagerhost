...
<form id="userForm_editChannelDialog" method="post" action="<%=path%>/admin/zjh/channelMgr/modify">
	<table style="font-size: 12px;">
		<tr>
			...
			<td>
				<input type="text" id="channelId" name="channelId" readonly="readonly" style="width: 150px;border-color: gray;"/>
			</td>
		</tr>
		<tr>
			<td  style="display: inline-block; width: 150px; text-align: right; padding-right: 5px;">
		...
		<tr>
			...
			<td>
				<input type="text" id="externChannel" name="externChannel" class="easyui-validatebox" data-options="required:true,validType:['length[1,16]','validUnique[\'<%=path%>/admin/zjh/channelMgr/queryByOne\',\'externChannel\',\'channelId\']']" style="width: 150px;" />
			</td>
		</tr>
		<tr>
			<td  style="display: inline-block; width: 150px; text-align: right; padding-right: 5px;">
			...
			<td>
				<input type="text" id="username" name="username" class="easyui-validatebox" readonly="readonly" style="width: 150px;border-color: gray;" />
			</td>
		</tr>
		<tr>
			<td  style="display: inline-block; width: 150px; text-align: right; padding-right: 5px;">

...
<%String path = request.getContextPath(); %>
 <table id="table_grid"  style="min-width:1000px;" data-options="fitColumns:'true',rownumbers:'true',striped:'true'">
	...
	<thead>
		...
		<th data-options="field:'newLogin',sortable:'true',align:'center'" width='15%'>新登用户</th>
		<th data-options="field:'dosu0',sortable:'true',align:'center'" width='15%'>玩0局</th>
		<th data-options="field:'dosu1',sortable:'true',align:'center'" width='15%'>玩1局</th>
		<th data-options="field:'dosu2',sortable:'true',align:'center'" width='15%'>玩2局</th>
		<th data-options="field:'vnu',sortable:'true',align:'center'" width='15%'>玩3局</th>  
		<th data-options="field:'vnuPercent',sortable:'true',align:'center'" width='15%'>有效用户比例</th>  
		<th data-options="field:'userCost',sortable:'true',align:'center'" width='15%'>获取成本</th>
		</tr>
	</thead>
 	<tbody>
 	</tbody>
...
$(function(){ 
	$('#table_grid').datagrid({ 
		width:"auto",
	    height:"auto", 
	    url:"<%=path%>/admin/business/userFetch/query",
		checkOnSelect:false,
	  	selectOnCheck:false,
	  	singleSelect:true,
		striped:true, 

...
<%String path = request.getContextPath(); %>
 <table id="table_grid"  style="min-width:1000px;" data-options="fitColumns:'true',rownumbers:'true',striped:'true'">
	...
	<thead>
		...
		<th data-options="field:'d1rr',sortable:'true',align:'center'" width='15%'>1日留存</th>
		<th data-options="field:'d3rr',sortable:'true',align:'center'" width='15%'>3日留存</th>
		<th data-options="field:'d7rr',sortable:'true',align:'center'" width='15%'>7日留存</th>
		<th data-options="field:'d30rr',sortable:'true',align:'center'" width='15%'>30日留存</th>  
		<th data-options="field:'d60rr',sortable:'true',align:'center'" width='15%'>60日留存</th>  
		</tr>
	</thead>
 	<tbody>
 	</tbody>
...
$(function(){ 
	$('#table_grid').datagrid({ 
		width:"auto",
	    height:"auto", 
	    url:"<%=path%>/admin/business/userRetention/query",
		checkOnSelect:false,
	  	selectOnCheck:false,
	  	singleSelect:true,
		striped:true, 

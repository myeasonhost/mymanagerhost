...
<%String path = request.getContextPath(); %>
 <table id="table_grid"  style="min-width:1000px;" data-options="fitColumns:'true',rownumbers:'true',striped:'true'">
	...
	<thead>
    	...
    	<th data-options="field:'consumeNumber',sortable:'true',align:'center'" width='15%'>订单号</th>
...
<div id="table_tools" style="padding:0;height:auto;">  
	...
	<form id="queryParams" style="margin:0" >
		...
		<span style="width:80px;height:23px;margin:2px;padding:0px;" >（时分秒）
			订单金额（=）
...
$(function(){ 
	$('#table_grid').datagrid({ 
		width:"auto",
	    height:"auto", 
	    url:"<%=path%>/admin/zjh/rechargeDetail/query?payTypeId=25",
		checkOnSelect:false,
	  	selectOnCheck:false,
	  	singleSelect:true,
		striped:true, 

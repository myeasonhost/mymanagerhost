...
<form id='form_detailOrderApplyDialog' method='POST' enctype='multipart/form-data'>
		<div id="activityTabs" class="easyui-tabs" style="height: 465px ;">
		<div title="一：接单人基础信息" style="padding: 10px 10px;">
...
<!-- 							</tr> -->
		    ...
		    <div title="四：接单基本信息" style="padding: 10px">
           		<div style='padding: 5px 20px;'>
           				<table style='padding: 10px 25px;'>
							<tr style='height: 25px;'>
								<td>订单发布时间：</td>
								...
								<td>接单时间：</td>
								<td>
									<input type='text' id='applyTime' name="applyTime" style="width:140px;height:23px;margin:2px;padding:0px;" />
								</td>
							</tr>
							<tr style='height: 25px;'>
								<td>接单类型：</td>
								<td>
									<input name="applyType" type="radio" value="0" disabled="disabled" />个人接单
								  	<input name="applyType" type="radio" value="1" disabled="disabled" />企业接单
								</td>
							</tr>
						</table>
				</div>
...
<script type="text/javascript" charset="utf-8">
	...
	$(function(){
		com.eason.form.disableForm("form_detailOrderApplyDialog",true);
		new CustomerOpt();
	})
	</script>	
...
<form id="form_addCargoParamDialog" method="post" action="<%=path%>/admin/cargoparam/add" style="padding: 20px 30px;text-align:left;">
	<table style="font-size: 14px;">
		<tr>
			...
			<td>
				<input type="text" id="cargoParamId" name="cargoParamId" style="width: 200px;" class="easyui-validatebox"  data-options="required:true"/>
				<br><span style="color:red;font-size:10px;">(如：装货ID=LoadCargo)</span>
			</td>
		</tr>
		<tr>
			<td>

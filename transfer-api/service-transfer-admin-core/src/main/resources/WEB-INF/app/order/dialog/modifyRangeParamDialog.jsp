...
<form id="form_modifyRangeParamDialog" method="post" action="<%=path%>/admin/range/modify" style="padding: 20px 30px;text-align:left;">
	<table style="font-size: 14px;">
		<tr>
			...
			<td>
				<input type="hidden" id="rangeParamId" name="rangeParamId"/>
		...
		<tr>
			...
			<td>
				<input type="text" id="rangeMax" name="rangeMax" style="width: 200px;"  class="easyui-numberbox"  data-options="min:0,required:true"/><br>
				<span style="color:red;font-size:10px;">(大于最小件，请输入2147483647)</span>
			</td>
		</tr>
		<tr>
			<td>

...
<form id="form_acceptOrderApplyDialog" method="post" action="<%=path%>/admin/author/car/modify" style="padding: 20px 30px;text-align:left;">
	<table style="font-size: 14px;">
		<tr>
			<td colspan="2">
				再次确认<span style="color:red;">是否拒绝认证？</span>，并填写处理结果。
				<input type="hidden" id="carAuthorId" name="carAuthorId"/>

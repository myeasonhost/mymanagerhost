...
<form id='form_detailCarAuthorDialog' method='POST' enctype='multipart/form-data'>
		...
		<div title="一：客户基础信息" style="padding: 10px 10px;">
					...
					<table style='padding: 10px 25px;' >
						<tr style='height: 25px;'>
							...
							<td colspan="2">
								...
								认&nbsp;&nbsp;&nbsp;证id：<input type='text' id='carAuthorId' name="carAuthorId" style="width:120px;height:23px;margin:2px;padding:0px;" disabled="disabled"/><br/>
			...
			<div title="二：车辆基本信息" style="padding: 10px">
           			...
           			<fieldset style="margin: 5px;5px;">
           				...
           				<table style='padding: 10px 10px;'>
							<tr style='height: 25px;'>
								<td>车辆名称：</td>
								<td>
									<input type='text' id='carName' name="carName" style="width:120px;height:23px;margin:2px;padding:0px;"/>
								</td>
								<td>车牌号：</td>
								<td>
									<input type='text' id='carNo' name="carNo" style="width:120px;height:23px;margin:2px;padding:0px;"/>
								</td>
							</tr>
							<tr style='height: 25px;'>
								<td>车类型：</td>
								<td>
									<input type='text' id='carType' name="carType" style="width:120px;height:23px;margin:2px;padding:0px;" />
								</td>
								<td>车容：</td>
								<td>
									<input type='text' id='carNo' name="carNo" style="width:120px;height:23px;margin:2px;padding:0px;"/>
							...
							<tr style='height: 25px;'>
								<td>车定位地点：</td>
								<td colspan="3">
									<input type='text' id='carLocation' name="carLocation" style="width:300px;height:23px;margin:2px;padding:0px;" />
								</td>
							</tr>
							<tr style='height: 25px;'>
								<td>温度类型：</td>
								<td>
									<input type='text' id='tempType' name="tempType" style="width:120px;height:23px;margin:2px;padding:0px;"/>
								</td>
								<td>温度最低：</td>
								<td>
							...
							<tr style='height: 25px;'>
								<td>载重：</td>
								<td>
									<input type='text' id='loadWeight' name="loadWeight" style="width:120px;height:23px;margin:2px;padding:0px;" />
								</td>
								<td>创建时间：</td>
								<td>
									<input type='text' id='carCreateTime' name="carCreateTime" style="width:120px;height:23px;margin:2px;padding:0px;" />
								</td>
							</tr>
					</table>
					</fieldset>
           				...
           				<legend>车辆证件</legend>
           					<table style='padding: 10px 10px;'>
	           					<tr style='height: 25px;'>
									<td>机动车行驶证：</td>
									<td colspan="3">
										<img id="xszPic" name="xszPic" width="200" height="300" />
									</td>
									<td>道路运输证：</td>
									<td colspan="3">
										<img id="yszPic" name="yszPic" width="200" height="300" />
									</td>
								</tr>
								<tr style='height: 25px;'>
									<td>交通强制险：</td>
									<td colspan="3">
										<img id="qzxPic" name="qzxPic" width="200" height="300" />
									</td>
									<td>商业三责险：</td>
									<td colspan="3">
										<img id="szxPic" name="szxPic" width="200" height="300" />
									</td>
								</tr>
								<tr style='height: 25px;'>
									<td>货物损失险：</td>
									<td colspan="3">
										<img id="ssxPic" name="ssxPic" width="200" height="300" />
									</td>
									<td>通行证：</td>
									<td colspan="3">
										<img id="txzPic" name="txzPic" width="200" height="300" />
									</td>
								</tr>
							</table>
           			</fieldset>
		    ...
		    <div title="三：认证基本信息" style="padding: 10px">
           		<div style='padding: 5px 20px;'>
           			<fieldset style="margin: 5px;5px;">
           				...
           				<table style='padding: 10px 25px;'>
							<tr style='height: 25px;'>
								<td>车辆认证id：</td>
								<td>
									<input type='text' id='carAuthorId' name="carAuthorId" style="width:140px;height:23px;margin:2px;padding:0px;"/>
								</td>
								<td>认证名称：</td>
								<td>
									<input type='text' id='authorName' name="authorName" style="width:140px;height:23px;margin:2px;padding:0px;"/>
								</td>
							</tr>
							<tr style='height: 25px;'>
								<td>状态：</td>
								<td>
									<input type='text' id='authorStatus' name="status" style="color:red;width:140px;height:23px;margin:2px;padding:0px;" /><font color='red'>*</font>
								</td>
								<td>身份证：</td>
								<td>
									<input type='text' id='idCard' name="idCard" style="width:140px;height:23px;margin:2px;padding:0px;" />
								</td>
							</tr>
							<tr style='height: 25px;'>
								<td>所属企业：</td>
								<td>
									<input type='text' id='companyName' name="companyName" style="width:140px;height:23px;margin:2px;padding:0px;"/>
								</td>
								<td>创建时间：</td>
								<td>
									<input type='text' id='carAuthorCreateTime' name="carAuthorCreateTime" style="width:140px;height:23px;margin:2px;padding:0px;" />
								</td>
							</tr>
					</table>
           			</fieldset>
           			<fieldset style="margin: 5px;5px;">
           				...
           				<table style='padding: 10px 25px;'>
							<tr style='height: 25px;'>
								...
								<td>运营证照片：</td>
								<td colspan="3">
									<img id="operationCardPic" name="operationCardPic" width="200" height="300" />
								</td>
							</tr>	
							<tr style='height: 25px;'>
								<td>驾驶证照片：</td>
								<td colspan="3">
									<img id="carCardPic" name="carCardPic" width="200" height="300" />
								</td>
							</tr>	
					</table>
           			</fieldset>
...
<script type="text/javascript" charset="utf-8">
	...
	$(function(){
		com.eason.form.disableForm("form_detailCarAuthorDialog",true);
		new CustomerOpt();
	})
	</script>	
...
<form id='form_detailCargoCompanyAuthorDialog' method='POST' enctype='multipart/form-data'>
           			...
           			<fieldset style="margin: 5px;5px;">
           				...
           				<table style='padding: 10px 10px;'>
							<tr style='height: 25px;'>
								<td>企业id：</td>
								<td>
									<input type='text' id='cargoBusinessAuthorId' name="cargoBusinessAuthorId" style="width:120px;height:23px;margin:2px;padding:0px;"/>
								</td>
								<td>企业名称：</td>
								<td>
							...
							<tr style='height: 25px;'>
								...
								<td>创建时间：</td>
								<td>
									<input type='text' id='createTime' name="createTime" style="width:120px;height:23px;margin:2px;padding:0px;" />
								</td>
							</tr>
					</table>
					</fieldset>
...
<script type="text/javascript" charset="utf-8">
	...
	$(function(){
		com.eason.form.disableForm("form_detailCargoCompanyAuthorDialog",true);
		new CustomerOpt();
	})
	</script>	
...
<form id="form_acceptCargoAuthorDialog" method="post" action="<%=path%>/admin/author/cargo/modify" style="padding: 20px 30px;text-align:left;">
	<table style="font-size: 14px;">
		<tr>
			<td colspan="2">
				再次确认<span style="color:red;">是否通过认证？</span>，并填写处理结果。
				<input type="hidden" id="cargoAuthorId" name="cargoAuthorId"/>

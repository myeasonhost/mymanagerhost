...
<link type="text/css" href="<%=path %>/style/ht.css" rel="stylesheet"></link>
<style type="text/css">
#checkCode {
	cursor: hand;
	margin-top: 8px;
...
<script type="text/javascript" src="<%=path %>/js/bgstretcher.js"></script>
...
function do_login() {
	...
	$(document).ready(function(){
		...
		$('BODY').bgStretcher({
			images: ['<%=path %>/images/1.jpg', '<%=path %>/images/2.jpg', '<%=path %>/images/3.jpg'],
			imageWidth: 1024, 
			imageHeight: 768, 
			slideDirection: 'N',
			slideShowSpeed: 2000,
...
<body >
	<div class="ht warp1000">
    	 <div class="yzm" id="yzm">
            ...
            <div class="y">
            	<img src="<%=path %>/images/12.png" id="xx"></img>
                <img src="<%=path %>/images/34.png" class="im34" onclick="createCode();return false;"></img>
            </div>
            <script>

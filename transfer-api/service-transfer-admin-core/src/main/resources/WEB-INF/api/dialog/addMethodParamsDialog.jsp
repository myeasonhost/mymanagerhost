...
<form id="userForm_addMethodParamsDialog" method="post" action="<%=path%>/admin/api/apiMethodParams/add">
	<table style="font-size: 12px;">
		...
		<tr>
			...
			<td>
				<input name="isNecessary" type="radio" value="0" />否
				<input name="isNecessary" type="radio" value="1"  checked="checked"  />是
			</td>
		</tr>
		<tr>
			<td  style="display: inline-block; width: 150px; text-align: right; padding-right: 5px;">
		...
		<tr>
			...
			<td>
				<input name="paramClass" type="radio" value="0" />0-返回结果属性                   
				<input name="paramClass" type="radio" value="1"  checked="checked"  />1-应用级参数
			</td>

...
<form id='userForm_addMethodDialog' method='POST' action="<%=path%>/admin/api/apiMethod/add">
		<div style='padding: 10px 20px;'>
			<table style='padding: 10px 25px;' >
				...
				<tr style='height: 25px;'>
					<td>方法类别：</td>
					<td>
						<select id="methodType_add" name="methodType" style="width:130px;" class="easyui-combobox" class="easyui-validatebox" data-options="required:true">
						</select>
					</td>
					<td>调用等级：</td>
					<td>

...
\----------------------------------------------------------------------------*/
var checkbox_display = "close"; //选择类型 若为open则文本前加checkbox选择框
...
///////////////////////////////////////////////////////////////////////////////
var webFXTreeConfig = {
	rootIcon        : "images/xtreeImg/folder.png",
	openRootIcon    : "images/xtreeImg/openfolder.png",
	folderIcon      : "images/xtreeImg/folder.png",
	openFolderIcon  : "images/xtreeImg/openfolder.png",
	fileIcon        : "images/xtreeImg/file.png",
	iIcon           : "images/xtreeImg/I.png",
	lIcon           : "images/xtreeImg/L.png",
	lMinusIcon      : "images/xtreeImg/Lminus.png",
	lPlusIcon       : "images/xtreeImg/Lplus.png",
	tIcon           : "images/xtreeImg/T.png",
	tMinusIcon      : "images/xtreeImg/Tminus.png",
	tPlusIcon       : "images/xtreeImg/Tplus.png",
	plusIcon        : "images/xtreeImg/plus.png",
	minusIcon       : "images/xtreeImg/minus.png",
	blankIcon       : "images/xtreeImg/blank.png",
...
_p.target = null;
_p.toolTip = null;
_p.tip = null;//用于右键菜单所需要的链接信息
_p.type = null;//用于右键菜单所需要的结点类别信息
_p._focused = false;
...
_p.getLabelHtml = function () {
	...
	var chkboxText = "";
	if(checkbox_display == "open"){
		chkboxText = "<input type=\"checkbox\" id=\"chk"+this.getId()+"\" onclick='javascript:initCheckbox(this);' />";
	}
	return chkboxText+"<a href=\"" + webFXTreeHandler.textToHtml(this._getHref()) +
...
_p._onmousedown = function (e) {
	...
	if(e.button==2){
		...
		var t1 =  null;
		//若为a的时候设置节点的target
		var a = tree.getSelected().getTip();

		//控制是否为相片组,若为组则rel赋于赋于同样的值
		var g = false;
		tb_show_right(t1,a,g,e);
	}

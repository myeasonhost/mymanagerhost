		...
		<script type="text/javascript">
			$(function(){
				...
				$("#testForm > input[type='submit']").click(function(){
					...
					$("#textArea").val("");
					$.post(
					"http://localhost:8080/neo/api?method=neo.product.list&format=json&v=1.0&app_key=NMRPNQRORBPFOEOUOKOWOANKLCLOLCKQJXKRJWLAJYKUKJKEKBKEKBKEJTKF",
					$form.serialize(),
					function(data){
	...
	<div style="float:left;clear: both;width: 500px;">
		<fieldset>
			...
			<form id="testForm" name="testForm" action="#"
				...
				<textarea rows="20" cols="70" name="params"></textarea>
				</br>

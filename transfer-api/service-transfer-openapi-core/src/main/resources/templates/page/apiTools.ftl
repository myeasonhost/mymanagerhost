	...
	<div class="easyui-layout">
		<table style="width:990px;" border=0 align="center">
			<tr>
				...
				<form id='toSubmitRequest' method='post' enctype="multipart/form-data"  target="formSumit" action="handleSubmitRequest">
					<table cellspacing="4" width="100%">
						<tr>
							<td width="26%">请求地址</td>
							<td><input class="width98 combo" id="postUrl" name="postUrl" value = "http://127.0.0.1:8082/forward/api/router" maxlength="5000" /></td>
						...
						<tr>
							<td>API接口:</td>
							<td><input class="comboboxWidth" id="method" name="method" value = "${(systemParam.method)!''}" /></td>
						...
						<tr id="appKey">
							<td>appKey:</td>
							<td><input class="width98 combo" id="tmpAppkey" name="appKey" value = "${(systemParam.appKey)!'appKey00001'}" maxlength="5000" /></td>
							<td><em>*</em></td>
						</tr>
						<tr id="sessionKey" style="display:none">
							<td>sessionKey:</td>
							<td><input class="width98 combo" id="tmpSessionKey" name="sessionKey" value = "${(systemParam.sessionKey)!''}" maxlength="5000" /></td>
							<td></td>
						</tr>
						<tr>
							<td>appSecret:</td>
							<td><input class="width98 combo" id="appSecret" name="appSecret" value = "${(systemParam.appSecret)!'asdfghjkqwertyu'}" maxlength="5000" /></td>
							<td><em>*</em></td>
						</tr>
						<tr>
				...
				<iframe  name="formSumit"  width="500px" height="560px" frameborder="no" src="apiToolsResult" scrolling="no" >
				</iframe>

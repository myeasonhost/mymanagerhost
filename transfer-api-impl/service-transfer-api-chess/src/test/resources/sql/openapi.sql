...
insert  into `api_method_cfg`(`ID`,`METHOD_ID`,`VER`,`CFG_VALUE`,`IS_DELETED`,`CREATE_TIME`,`UPDATE_TIME`,`CREATE_BY`,`UPDATE_BY`) values (2,2,'1.0.0','remote;com.eason.transfer.openapi.core.sdk.zb.IUserService;login;com.eason.transfer.openapi.core.sdk.zb.model.LoginRequest',0,NULL,NULL,NULL,NULL);
...
insert  into `api_method_cfg`(`ID`,`METHOD_ID`,`VER`,`CFG_VALUE`,`IS_DELETED`,`CREATE_TIME`,`UPDATE_TIME`,`CREATE_BY`,`UPDATE_BY`) values (11,11,'1.0.0','remote;com.eason.transfer.openapi.core.sdk.zb.IUserService;login;com.eason.transfer.openapi.core.sdk.zb.model.LoginRequest',0,NULL,NULL,NULL,NULL);

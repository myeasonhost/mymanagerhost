...
insert  into `api_method_cfg`(`ID`,`METHOD_ID`,`VER`,`CFG_VALUE`,`IS_DELETED`,`CREATE_TIME`,`UPDATE_TIME`,`CREATE_BY`,`UPDATE_BY`) values (11,11,'1.0.0','remote;com.eason.transfer.openapi.core.sdk.user.IUserService;login;com.eason.transfer.openapi.core.sdk.user.LoginRequest',0,NULL,NULL,NULL,NULL);
insert  into `api_method_cfg`(`ID`,`METHOD_ID`,`VER`,`CFG_VALUE`,`IS_DELETED`,`CREATE_TIME`,`UPDATE_TIME`,`CREATE_BY`,`UPDATE_BY`) values (12,12,'1.0.0','remote;com.eason.transfer.openapi.core.sdk.user.IUserService;transferIn;com.eason.transfer.openapi.core.sdk.user.TransferInRequest',0,NULL,NULL,NULL,NULL);
insert  into `api_method_cfg`(`ID`,`METHOD_ID`,`VER`,`CFG_VALUE`,`IS_DELETED`,`CREATE_TIME`,`UPDATE_TIME`,`CREATE_BY`,`UPDATE_BY`) values (13,13,'1.0.0','remote;com.eason.transfer.openapi.core.sdk.user.IUserService;transferOut;com.eason.transfer.openapi.core.sdk.user.TransferOutRequest',0,NULL,NULL,NULL,NULL);
insert  into `api_method_cfg`(`ID`,`METHOD_ID`,`VER`,`CFG_VALUE`,`IS_DELETED`,`CREATE_TIME`,`UPDATE_TIME`,`CREATE_BY`,`UPDATE_BY`) values (14,14,'1.0.0','remote;com.eason.transfer.openapi.core.sdk.user.IUserService;queryBalance;com.eason.transfer.openapi.core.sdk.user.QueryBalanceRequest',0,NULL,NULL,NULL,NULL);
insert  into `api_method_cfg`(`ID`,`METHOD_ID`,`VER`,`CFG_VALUE`,`IS_DELETED`,`CREATE_TIME`,`UPDATE_TIME`,`CREATE_BY`,`UPDATE_BY`) values (15,15,'1.0.0','remote;com.eason.transfer.openapi.core.sdk.user.IUserService;queryOrderStatus;com.eason.transfer.openapi.core.sdk.user.OrderStatusRequest',0,NULL,NULL,NULL,NULL);
insert  into `api_method_cfg`(`ID`,`METHOD_ID`,`VER`,`CFG_VALUE`,`IS_DELETED`,`CREATE_TIME`,`UPDATE_TIME`,`CREATE_BY`,`UPDATE_BY`) values (16,16,'1.0.0','remote;com.eason.transfer.openapi.core.sdk.user.IUserService;queryPlayerStatus;com.eason.transfer.openapi.core.sdk.user.PlayerStatusRequest',0,NULL,NULL,NULL,NULL);
insert  into `api_method_cfg`(`ID`,`METHOD_ID`,`VER`,`CFG_VALUE`,`IS_DELETED`,`CREATE_TIME`,`UPDATE_TIME`,`CREATE_BY`,`UPDATE_BY`) values (17,17,'1.0.0','remote;com.eason.transfer.openapi.core.sdk.user.IUserService;getBetRecordList;com.eason.transfer.openapi.core.sdk.user.PullBetRequest',0,NULL,NULL,NULL,NULL);
insert  into `api_method_cfg`(`ID`,`METHOD_ID`,`VER`,`CFG_VALUE`,`IS_DELETED`,`CREATE_TIME`,`UPDATE_TIME`,`CREATE_BY`,`UPDATE_BY`) values (18,18,'1.0.0','remote;com.eason.transfer.openapi.core.sdk.user.IUserService;getWalletList;com.eason.transfer.openapi.core.sdk.user.WalletListRequest',0,NULL,NULL,NULL,NULL);
insert  into `api_method_cfg`(`ID`,`METHOD_ID`,`VER`,`CFG_VALUE`,`IS_DELETED`,`CREATE_TIME`,`UPDATE_TIME`,`CREATE_BY`,`UPDATE_BY`) values (19,19,'1.0.0','remote;com.eason.transfer.openapi.core.sdk.user.IReportService;getUserGameTypeReport;com.eason.transfer.openapi.core.sdk.user.ReportUserGameTypeRequest',0,NULL,NULL,NULL,NULL);
insert  into `api_method_cfg`(`ID`,`METHOD_ID`,`VER`,`CFG_VALUE`,`IS_DELETED`,`CREATE_TIME`,`UPDATE_TIME`,`CREATE_BY`,`UPDATE_BY`) values (20,20,'1.0.0','remote;com.eason.transfer.openapi.core.sdk.user.IReportService;getUserGameKindReport;com.eason.transfer.openapi.core.sdk.user.ReportUserGameKindRequest',0,NULL,NULL,NULL,NULL);

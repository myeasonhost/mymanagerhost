	...
	$(function(){
		...
		function UserAction(){
			...
			function validateUserForm(){
				...
				if($.trim($("#userForm input[name='pwd']").val()) == ''){
					$.messager.alert('提示','密码未填写!','warning'); //密码未填写
					return false;
				}
				if($.trim($("#userForm input[name='rePwd']").val()) == ''){
					$.messager.alert('提示','重复密码未填写!','warning'); //重复密码未填写
					return false;
				}

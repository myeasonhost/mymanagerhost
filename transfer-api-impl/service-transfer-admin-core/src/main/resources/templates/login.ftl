...
<link type="text/css" href="/style/ht.css" rel="stylesheet"></link>
<style type="text/css">
#checkCode {
	cursor: hand;
	margin-top: 8px;
...
function do_login() {
		  ...
		  var user_pwd = frm.user_pwd.value;
		   ...
		   $.post(
		   		"/admin/user/login?date="+new Date(),
		   		$(frm).serialize(),
		   		function(data){
		   			if(!data.result){
...
<body >
	<div class="ht warp1000">
    	 <div class="yzm" id="yzm">
            ...
            <div class="y">
            	<img src="/images/12.png" id="xx"></img>
                <img src="/images/34.png" class="im34" onclick="createCode();return false;"></img>
            </div>
            <script>
        ...
        <p class="p3">content Manage System Powered By：©QLIN-cms Version:2.3  CopyRight 2010-2015. </p>

...
insert  into `api_method_cfg`(`ID`,`METHOD_ID`,`VER`,`CFG_VALUE`,`IS_DELETED`,`CREATE_TIME`,`UPDATE_TIME`,`CREATE_BY`,`UPDATE_BY`) values (11,11,'1.0.0','remote;com.eason.transfer.openapi.core.sdk.chess.IUserService;login;com.eason.transfer.openapi.core.sdk.user.LoginRequest',0,NULL,NULL,NULL,NULL);

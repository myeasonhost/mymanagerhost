...
import com.ds.money.dao.mapper.DsMemberMoneyLogMapper;
...
public class MemberMoneyServiceImp{
	 ...
	 *
	 */
	public void getMoney(String username, Integer siteId, UserMoneyResponse response, Map<String, Object> data)throws Exception {
		//String money = (String) redisTemplate.opsForValue().get(siteId+"_"+username);
		String money =null;
		//缓存中有数据
		if(!StringUtils.isBlank(money)){
		//	logger.info("从缓存中获取数据");
			response.setMoey(new BigDecimal(money));
...
//			}
		...
		response.setMoey(memberMoney.getMoney());
...
//		List<DsMemberMoney> list = moneyMapper.selectByExample(e);
	...
	public void transMoney(String username, Integer siteId, String remitno, String transType,
...
//			}
	...
	public void memberMoneyLog(JSONObject result, MemberMoneyLogResponse response, MoneyLogParam queryParam, Page<DsMemberMoneyLog> pagation) {
...
//			response.setPage(pagation.getPageNo());
//			response.setPageSize(pagation.getPageSize());
//		    response.setTotalNumber(totalCount);
//			return;
//		}
//

...
<form method="post" action="testByPost.action" name="testform" enctype="multipart/form-data">
    ...
    <strong>测试环境：</strong>
    <input style="width:500px" type='text' name="routerUrl"
           value="${routerUrl!"http://openapi.1mall.com:8090/app/api/rest/router"}"/>
        ...
        <tr>
            <td>
                <table style="width:600px" border=0>
                    <tr>
                        <td colspan=2><strong>系统级参数：</strong></td>
                    </tr>
                    <tr>
                        <td>appKey:</td>
                    ...
                    <tr>
                        <td>时间戳:</td>
                        <td><input id="timestamp" type='text' value="${timestamp!''}" name="timestamp"
                                   style="width:300px"/>

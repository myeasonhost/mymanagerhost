...
@Repository
public interface MdtJDMgo extends MongoRepository<MdtJDMgoPo, BigInteger>, PagingAndSortingRepository<MdtJDMgoPo, BigInteger>{
////    @Query("{'userId':{$in:?#{[0]}}}")
...
////    AgModel findByZbId(Integer zbId);
        ...
        MdtJDMgoPo findAllBySiteId(Integer siteId, Long startId, Long endId);
}

package com.eason.report.pull.sgs.vo.slot;
...
@AllArgsConstructor
@XStreamAlias("result")
public class SlotOrdersTExRo implements Serializable{
    ...
    private List<SlotOrdersTExRoList> SlotOrdersTExRoList;

    @XStreamAlias("row")
    class SlotOrdersTExRoList{

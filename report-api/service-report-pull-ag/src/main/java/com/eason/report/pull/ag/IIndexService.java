...
import com.eason.report.pull.ag.vo.index.BannerResponseVo;
import com.eason.report.pull.ag.vo.index.IndexResponseVo;
import com.eason.report.pull.ag.vo.index.MsgNotificationResponseVo;
import com.eason.report.pull.ag.exception.ServiceException;
import com.eason.report.pull.ag.model.PageModel;
...
public interface IIndexService {
	 ...
	 * @apiSuccess {String} row.roomType   	房间类型：
